                ...
                <div className='w-2/3 my-3'>
                    <div className="home-team flex justify-between my-1 mx-auto place-content-center w-1/2">
                        <div className='flex flex-col md:flex-row'>
                            <img className='object-fill sm:mr-2 h-16' src={match.homeTeam.crest} alt={match.homeTeam.shortName} />
                    ...
                    <div className='home-team flex justify-between my-1 mx-auto place-content-center w-1/2'>
                        <div className="flex flex-col md:flex-row">
                            <img className='object-fill sm:mr-2 h-16' src={match.awayTeam.crest} alt={match.awayTeam.shortName} />
